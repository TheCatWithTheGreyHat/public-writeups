...
<p align="center">
  <img src=".imgs/greycat.jpg" alt="Selfie del programmatore" width="280" style="border-radius:10px; box-shadow:0 0 10px rgba(0,0,0,0.3);"/>
  <br>
  <span style="font-size:0.9em; color:gray;">Autore della repo in persona ⬆</span>
  <br>
  <i style="color:gray;">«Ma come **** si mettono le immagini nel README?» — greyhat, 2025</i>
</p>
